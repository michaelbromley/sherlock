...
|------------|-----------|----------|-------------|
| **Id** | bigint | NO | Primary key, unique identifier for each locality |
| **Name** | nvarchar(255) | NO | Name of the locality in local language/script |
...
| **ElectoralUnitId** | bigint | YES | Foreign key to ElectoralUnits table (Bahai administrative unit) |
