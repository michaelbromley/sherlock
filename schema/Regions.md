...
|------------|-----------|----------|-------------|
| **Id** | bigint | NO | Primary key, unique identifier for each region |
| **Name** | nvarchar(255) | NO | Name of the region in local language/script |
...
| **GroupOfRegionId** | bigint | YES | Foreign key to GroupOfRegions table (optional grouping) |
