-- Junior Youth Cohort Progression Analysis for San Gabriel Cluster
-- This query tracks JY who started in each year (2017-2025) and their subsequent completions
--
-- COHORT DEFINITION:
...
--   For each cohort year, we track cumulative completions across ALL subsequent years
...
-- ============================================================================
-- SUMMARY TABLE: Aggregated statistics by cohort year
-- ============================================================================
SELECT
    C.CohortYear,
...
-- ============================================================================
-- INDIVIDUAL DETAIL TABLE: Names and progression for verification
-- ============================================================================
SELECT
    C.CohortYear,
    I.[FirstName],
